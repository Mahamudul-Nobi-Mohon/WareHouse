...
namespace WMS
{
    public partial class AddRoom : Form
    {
        ...
        public void DataGrid()
        {
            ...
            cmd.CommandText = "SELECT Location.LocationID AS 'ID', Location.LocationName AS 'Location Name', LocationMain.LocationMainName AS 'Warehouse Name' FROM Location INNER JOIN LocationMain ON Location.LocationMainID = LocationMain.LocationMainID";
            cmd.ExecuteNonQuery();
